export async function onRequest(context) {
  ...
  // 1. ASSET PASS-THROUGH (Now includes Fonts!)
  // We added woff, woff2, ttf, and otf so you can host your custom US101 font in R2
  if (path.match(/\.(jpg|jpeg|png|webp|gif|woff|woff2|ttf|otf)$/i)) {
  ...
  const html = `
    ...
    <head>
      ...
      <style>
        /* Load custom US101 font. Make sure to upload US101.woff to your R2 bucket root */
        @font-face {
          font-family: 'US101';
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        aside nav { margin-top: 50px; display: flex; flex-direction: column; gap: 15px; }
        ...
        .nav-section-title { font-size: 11px; color: #999; margin-top: 20px; margin-bottom: 5px; text-transform: uppercase; letter-spacing: 2px; }
        .folder-link { text-transform: capitalize; letter-spacing: 1px; }

        /* Main Content - Masonry Column Layout */
        ...
        /* Static Pages */
        .static-page { max-width: 600px; line-height: 1.8; font-family: sans-serif; letter-spacing: normal; }
